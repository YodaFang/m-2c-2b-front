...
const CheckoutPayment = () => {
  return (
    <div className="bg-secondary sm:p-10 p-7 rounded-xl">
      <div className="border border-primary/60 sm:p-7.5 p-5 rounded-lg">
        ...
        <div className="overflow-x-auto">
          <div className="mt-7.5  min-w-[350px]">
            <div className="flex justify-between border-b-[1.5px] border-b-secondary-foreground/40 pb-5">
              <p className="lg:text-2xl sm:text-xl text-lg lg:leading-[125%] font-semibold">
                Product
              </p>
              <p className="lg:text-2xl sm:text-xl text-lg lg:leading-[125%] font-semibold">
                Subtotal
            ...
            <div className="mt-7.5 flex flex-col gap-5 border-b-[1.5px] border-b-secondary-foreground/40 pb-7.5">
              <div className="flex justify-between">
                <div className="flex items-center gap-5">
                  ...
                  />
                  <div>
                    <p className="lg:text-xl sm:text-lg text-base font-medium">
                      Modern Tolik Chair
                    </p>
